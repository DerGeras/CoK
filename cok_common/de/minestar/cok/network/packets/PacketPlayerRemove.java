...
public class PacketPlayerRemove extends CoKPacket {

	private String teamName, playerName;

	public PacketPlayerRemove(String teamName, String playerName) {
		super(PacketHandler.PLAYER_REMOVE);
		this.teamName = teamName;
		this.playerName = playerName;
	}

	public PacketPlayerRemove(DataInputStream input, Player player) throws Exception {
		super(input, player);
	}
