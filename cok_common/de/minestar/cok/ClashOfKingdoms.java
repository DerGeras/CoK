...
public class ClashOfKingdoms {
	...
	// MetadatablockNames
	public static final String[] socketBlockNames = {"Black Socket", "Dark Blue Socket", "Dark Green Socket", "Dark Aqua Socket", "Dark Red Socket", "Purple Socket", "Gold Socket", "Gray Socket", "Dark Gray Socket", "Blue Socket", "Green Socket", "Aqua Socket", "Red Socket", "Light Purple Socket", "Yellow Socket", "White Socket"};
	...
	private void registerItems() {
		...
		// //register cokHelmet
		// cokHelmetItem = new ItemCoKHelmet(cokHelmetID,
